...
router.post('/', async (req, res) => {
    ...
    const emailOptions = {
        ...
        body: {
            ...
            cc: cc,
            bcc,
            subject: "Alert for 1 day after site visit - " + caseNumber + " - " + caseSubject + "",
            html: `<body>Dear All</br></br>

            Alert for 1 day after site visit.</br></br>

            Reference Number : `+ caseNumber + `</br>
            Summary : ` + caseSubject + `</br>
            Service : `+ serviceName + `</br></br>` + body + `</br></br>

            <a href="https://hgcitd.atlassian.net/browse/` + caseNumber + `">View request</a></br></br></body>
...
`
    ...
    options = {
        ...
        body: { name: 'AlertMsgAfterSiteVisit' },//'Creator User Info' },
        json: true
    }
