...
router.post('/', async (req, res) => {
    ...
    let emailOptions = {
        ...
        body: {
            ...
            subject: "The request of Postal Service was outstanding - " + caseNumber
        }
    }
    ...
    emailOptions.body.html = `Dear FADM admin,<br><br>

    The captioned Postal Service has been outstanding for 1 day.<br>
