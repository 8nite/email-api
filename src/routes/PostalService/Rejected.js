...
router.post('/', async (req, res) => {
    ...
    let emailOptions = {
        ...
        body: {
            ...
            subject: "The request of Postal Service " + caseNumber + " was rejected"
        }
    }
    ...
    The request of Postal Service was rejected due to mail quantity not matched with the attached list.<br>
