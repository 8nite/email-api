...
router.post('/', async (req, res) => {
    ...
    const emailOptions = {
        ...
        body: {
            ...
            to: to,
            cc: cc,
            subject: caseSeverity + ' - ' + caseNumber + ' - ' + serviceName + ' - ' + caseSubject + ' - Resolve Time SLA breached',
            html: `Dear All</br></br>
This is an alert on a ` + caseSeverity + ` case ` + caseNumber + ` is breached SLA on the response time</br></br>
