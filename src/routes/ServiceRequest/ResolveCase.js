...
router.post('/', async (req, res) => {
    ...
    const emailOptions = {
        ...
        body: {
            ...
            cc: cc,
            bcc,
            subject: 'HGC Service Desk - ' + caseNumber + ' - ' + caseSubject + ' status had been changed to completed',
            html: `Dear ` + userName + `</br></br>

            This is to acknowledge that ` + statusChanger + ` had changed the case  ` + caseNumber + ` status to be completed</br></br>
